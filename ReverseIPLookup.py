...
def search(remoteAddr):
    ...
    while(q):
        ...
        try:
            ...
            getRequest = Request(
                address, headers={"User-Agent": custom_user_agent})
...
print(pyfiglet.figlet_format("Reverse IP Lookup") +
      "\t\t\t\t\twritten by batininhani\n")
...
try:
    ...
    displayMessage("\r%sThere was an error resolving the host" %
                   bcolors.fail("[-]"))
    sys.exit(1)
